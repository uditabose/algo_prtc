...
def calculate_water(left_boundary: int, right_boundary: int, height: List[int]) -> int:
    ...
    for index in range(left_boundary + 1, right_boundary + 1):
        water += abs(height[index] - height[left_boundary])
...
def trapping_rain_water(height: List[int]) -> int:
    ...
    while current_index < len(height):
        if left_boundary >= current_index:
            continue
...
def run():
    print("-----------")
    print(trapping_rain_water([0,1]))
    print("-----------")
    print(trapping_rain_water([0,0,0]))
    print("-----------")
    print(trapping_rain_water([1,1,1]))
    print("-----------")
    print(trapping_rain_water([1,2,3]))
    print("-----------")
    print(trapping_rain_water([3,2,1]))
    print("-----------")
    print(trapping_rain_water([3,2,1,0,1,2,3]))
    print("-----------")
